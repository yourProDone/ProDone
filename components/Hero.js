    ...
    <section id="home" className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 w-full flex flex-col items-center py-12">
        ...
        >
          ...
          >
            We Build Tech That{' '}
            <span className="gradient-text  animate-glow">Performs</span>
          </motion.h1>
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <motion.div
          ...
          className="absolute top-20 left-10 w-4 h-4 bg-primary-500/30 rounded-full"
        />
        <motion.div
          animate={{ y: [0, 20, 0] }}
          transition={{ duration: 6, repeat: Infinity }}
          className="absolute top-40 right-20 w-6 h-6 bg-primary-500/20 rounded-full"
        />
        <motion.div
          animate={{ y: [0, -15, 0] }}
          transition={{ duration: 5, repeat: Infinity }}
          className="absolute bottom-40 left-20 w-3 h-3 bg-primary-500/40 rounded-full"
        />
      </div>
    </section>
  );
